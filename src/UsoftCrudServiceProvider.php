...
namespace Usoft\Crud;

use Illuminate\Support\ServiceProvider;
use Usoft\Crud\Middlewares\LocaleMiddleware;
use Usoft\Crud\Middlewares\TimezoneMiddleware;

class UsoftCrudServiceProvider extends ServiceProvider
{
    /**
    ...
    public function boot()
    {
        ...
        */
        ...
        $this->loadTranslationsFrom(__DIR__ . '/../lang', 'usoft_crud_translations');
        if ($this->app->runningInConsole()) {
            $this->publishes([
                __DIR__ . '/../config/usoft_crud.php' => config_path('usoft_crud.php'),
            ], 'config');
            $this->publishes([
