...
namespace Usoft\Crud\Abstracts\Http;
...
use Usoft\Crud\Requests\SearchRequest;
use Usoft\Crud\Requests\UserRequest;
...
abstract class FormRequest extends BaseFormRequest
{
    ...
    {
        return config('usoft_crud.authorize', false);
    }
    ...
    protected function failedValidation(Validator $validator)
    {
        $response = new Response([
            'message' => trans('usoft_crud_translations::' . $validator->errors()->first())
        ], 422);
